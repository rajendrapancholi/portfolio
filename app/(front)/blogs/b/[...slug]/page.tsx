...
export async function generateMetadata({ params }: Props) {
    ...
    if (!slug || slug.length < 2) return createPageMetadata({
        title: "Invalid URL",
    ...
    return createPageMetadata({
        ...
        keywords: ["Scalability", "NoSQL", "Consistency", "Backend"],
                ...
                <article className="col-span-4 w-full px-2">
                    ...
                    <footer className="mt-20 border-t border-slate-800/60 py-16">
                        <div className="flex flex-col gap-12">
                            ...
                            <div aria-label="Like this post" className="flex justify-center items-center gap-4">
                                <button
                                    className="group flex items-center gap-3 px-6 py-3 rounded-full bg-slate-900 border border-slate-800 hover:border-pink-500/50 transition-all duration-300 shadow-xl shadow-black/20"
                                >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                {prevBlog ? (
                                    ...
                                    >
                                        <div className="flex items-center gap-2 text-slate-500 group-hover:text-cyan-400 transition-colors">
                                            ...
                                            <span className="text-xs uppercase tracking-widest font-semibold">Previous</span>
                                        </div>
                                    ...
                                    <div className="p-6 rounded-2xl bg-slate-900/20 border border-slate-800/30 opacity-50 flex flex-col gap-2">
                                        <span className="text-xs uppercase tracking-widest font-semibold text-slate-600">No Previous Post</span>
                                    </div>
                                )}
                                ...
                                {nextBlog ? (
                                    ...
                                    <div className="p-6 rounded-2xl bg-slate-900/20 border border-slate-800/30 opacity-50 flex flex-col items-end gap-2 text-right">
                                        <span className="text-xs uppercase tracking-widest font-semibold text-slate-600">No Next Post</span>
                                    </div>
                                )}
                            </div>
