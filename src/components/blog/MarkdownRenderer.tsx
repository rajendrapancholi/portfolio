...
const MarkdownComponents = {
  code: ({ className, children, node, ...props }: any) => {
    ...
    return <CodeBlock className={className}>{rawText}</CodeBlock>;
  },
...
const MarkdownRenderer = ({ content }: { content: string }) => {
  ...
  return (
    <div className="markdown-render bg-main-bg" data-color-mode={currentTheme}>
      <MarkdownPreview
...
//       ? getCodeString(codeNode.children).replace(/\n$/, '')
//       : '';
