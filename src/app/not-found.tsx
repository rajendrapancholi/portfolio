  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#0a0a0a] px-6 text-center">
      ...
      <div className="z-10 flex flex-col items-center max-w-2xl">
        <div
          className="tooltip tooltip-top tooltip-info mb-12 scale-125 hover:scale-110 transition-transform duration-500 ease-out capitalize"
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-400 text-lg md:text-xl max-w-md mx-auto leading-relaxed mt-4">
            The system has encountered a logic gap. The requested path does not
            exist within the{' '}
            <span className="text-white font-semibold">RajeDev</span> ecosystem.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-5 mt-12 w-full sm:w-auto">
          ...
          >
            ...
            <span className="font-bold tracking-wide cursor-pointer">
              Back to Reality
            </span>
          </button>
