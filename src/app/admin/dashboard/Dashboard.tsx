    ...
    <div className=" transition-colors duration-500">
        ...
        >
          ...
          <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400 mt-1">
            ...
            <span className="text-sm font-medium">
              Fiscal Year {new Date().getFullYear()} • Updated Live
            </span>
          </div>
        </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {[
          ...
          >
            <div
              className={`p-3 rounded-2xl bg-${stat.color}-50 dark:bg-${stat.color}-500/10 text-${stat.color}-600 dark:text-${stat.color}-400 w-fit mb-4`}
            >
              {stat.icon}
            </div>
            ...
            <div className="flex items-baseline gap-2">
              <h3 className="text-3xl font-black text-slate-900 dark:text-white my-1">
                {stat.value}
              </h3>
        ...
        >
          ...
          <div className="mt-6 p-4 bg-white/10 rounded-2xl backdrop-blur-md border border-white/10">
            ...
            <p className="text-sm font-bold">
              Category "Development" is up 14% this month.
            </p>
          </div>
        </motion.div>
      </div>
